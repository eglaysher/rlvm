...
/**
 * Callback interface for receiving messages from a GCNMenu.
 */
class GCNMenuListener : public GCNWindowListener {
public:
  virtual void receiveGCNMenuEvent(GCNMenu* menu, const std::string& event) = 0;
};
...
private:
  ...
  /// Receives our events (which dismiss this menu object).
  GCNMenuListener* listener_;
