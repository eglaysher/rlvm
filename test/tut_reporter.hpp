...
namespace tut
{
  ...
  public:
    ...
    void run_completed()
    {
      ...
      os << "tests summary:" << endl;
      if( terminations_count > 0 ) os << "  terminations: " << terminations_count << endl;
      if( exceptions_count > 0 ) os << "  exceptions: " << exceptions_count << endl;
      if( failures_count > 0 ) os << "  failures: " << failures_count << endl;
      if( warnings_count > 0 ) os << "  warnings: " << warnings_count << endl;
      os << "  ok: " << ok_count << endl;
    }
