...
std::vector<PromotionData> data = {
  ...
  std::make_tuple("grpLoad", 0,
                  TestMachine::Arg("file", 0),
                  NONE),
  std::make_tuple("grpLoad", 1,
                  TestMachine::Arg("file", 0, 255),
                  NONE),
  std::make_tuple("grpLoad", 2,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0),
                  NONE),
  std::make_tuple("grpLoad", 3,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0, 255),
                  NONE),
  std::make_tuple("recLoad", 0,
                  TestMachine::Arg("file", 0),
                  NONE),
  std::make_tuple("recLoad", 1,
                  TestMachine::Arg("file", 0, 255),
                  NONE),
  std::make_tuple("recLoad", 2,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0),
                  NONE),
  std::make_tuple("recLoad", 3,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0, 255),
                  NONE),
  std::make_tuple("grpMaskLoad", 0,
                  TestMachine::Arg("file", 0),
                  NONE),
  std::make_tuple("grpMaskLoad", 1,
                  TestMachine::Arg("file", 0, 255),
                  NONE),
  std::make_tuple("grpMaskLoad", 2,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0),
                  NONE),
  std::make_tuple("grpMaskLoad", 3,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0, 255),
                  NONE),
  std::make_tuple("recMaskLoad", 0,
                  TestMachine::Arg("file", 0),
                  NONE),
  std::make_tuple("recMaskLoad", 1,
                  TestMachine::Arg("file", 0, 255),
                  NONE),
  std::make_tuple("recMaskLoad", 2,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0),
                  NONE),
  std::make_tuple("recMaskLoad", 3,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0, 255),
                  NONE),

  std::make_tuple("grpCopy", 0,
                  TestMachine::Arg(1, 0),
                  NONE),
  std::make_tuple("grpCopy", 1,
                  TestMachine::Arg(1, 0, 255),
                  NONE),
  std::make_tuple("grpCopy", 2,
                  TestMachine::Arg(0, 0, 200, 200, 1, 0, 0, 0),
                  NONE),
  std::make_tuple("grpCopy", 3,
                  TestMachine::Arg(0, 0, 200, 200, 1, 0, 0, 0, 255),
                  NONE),
  std::make_tuple("recCopy", 0,
                  TestMachine::Arg(1, 0),
                  NONE),
  std::make_tuple("recCopy", 1,
                  TestMachine::Arg(1, 0, 255),
                  NONE),
  std::make_tuple("recCopy", 2,
                  TestMachine::Arg(0, 0, 200, 200, 1, 0, 0, 0),
                  NONE),
  std::make_tuple("recCopy", 3,
                  TestMachine::Arg(0, 0, 200, 200, 1, 0, 0, 0, 255),
                  NONE),

  // These commands should promote:
  std::make_tuple("grpDisplay", 0,
                  TestMachine::Arg(0, 5),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("grpDisplay", 1,
                  TestMachine::Arg(0, 5, 255),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("grpDisplay", 2,
                  TestMachine::Arg(0, 5, 0, 0, 200, 200, 0, 0),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("grpDisplay", 3,
                  TestMachine::Arg(0, 5, 0, 0, 200, 200, 0, 0, 255),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("recDisplay", 0,
                  TestMachine::Arg(0, 5),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("recDisplay", 1,
                  TestMachine::Arg(0, 5, 255),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("recDisplay", 2,
                  TestMachine::Arg(0, 5, 0, 0, 200, 200, 0, 0),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("recDisplay", 3,
                  TestMachine::Arg(0, 5, 0, 0, 200, 200, 0, 0, 255),
                  SHOULD_PROMOTE_BG),

  std::make_tuple("grpOpenBg", 0,
                  TestMachine::Arg("file", 0),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("grpOpenBg", 1,
                  TestMachine::Arg("file", 0, 255),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("grpOpenBg", 2,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("grpOpenBg", 3,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0, 255),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("recOpenBg", 0,
                  TestMachine::Arg("file", 0),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("recOpenBg", 1,
                  TestMachine::Arg("file", 0, 255),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("recOpenBg", 2,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("recOpenBg", 3,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0, 255),
                  SHOULD_PROMOTE_BG),

  std::make_tuple("grpMaskOpen", 0,
                  TestMachine::Arg("file", 0),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("grpMaskOpen", 1,
                  TestMachine::Arg("file", 0, 255),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("grpMaskOpen", 2,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("grpMaskOpen", 3,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0, 255),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("recMaskOpen", 0,
                  TestMachine::Arg("file", 0),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("recMaskOpen", 1,
                  TestMachine::Arg("file", 0, 255),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("recMaskOpen", 2,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("recMaskOpen", 3,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0, 255),
                  SHOULD_PROMOTE_BG),

  std::make_tuple("recMulti", 0,
                  TestMachine::Arg("file", 0),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("recMulti", 1,
                  TestMachine::Arg("file", 0, 255),
                  SHOULD_PROMOTE_BG),

  std::make_tuple("grpOpen", 0,
                  TestMachine::Arg("file", 0),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("grpOpen", 1,
                  TestMachine::Arg("file", 0, 255),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("grpOpen", 2,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("grpOpen", 3,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0, 255),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("recOpen", 0,
                  TestMachine::Arg("file", 0),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("recOpen", 1,
                  TestMachine::Arg("file", 0, 255),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("recOpen", 2,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0),
                  SHOULD_PROMOTE_BG),
  std::make_tuple("recOpen", 3,
                  TestMachine::Arg("file", 0, 0, 0, 200, 200, 0, 0, 255),
                  SHOULD_PROMOTE_BG)
};
